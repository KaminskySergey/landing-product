            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
                    <div className="flex items-center mb-4">
                        <img src="/public/user.png" alt="user1" className="w-12 h-12 rounded-full mr-3" />
                        <div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
                    <div className="flex items-center mb-4">
                        <img src="/public/user.png" alt="user2" className="w-12 h-12 rounded-full mr-3" />
                        <div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
                    <div className="flex items-center mb-4">
                        <img src="/public/user.png" alt="user3" className="w-12 h-12 rounded-full mr-3" />
                        <div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
                    <div className="flex items-center mb-4">
                        <img src="/public/user.png" alt="user4" className="w-12 h-12 rounded-full mr-3" />
                        <div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
                    <div className="flex items-center mb-4">
                        <img src="/public/user.png" alt="user5" className="w-12 h-12 rounded-full mr-3" />
                        <div>
