...
export function Hero({ scrollToForm }: IHero) {
    return <section className="py-[64px] lg:py-[94px] bg-[#E6F1FB]">
        <div className="sm:px-4 md:px-8 mx-auto flex flex-col md:flex-row gap-4 items-center max-w-[1440px] ">
            ...
            <div className="w-full md:w-1/2">
                <div className="">
                    ...
                    <h1 className="mb-6 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Килимок з підігрівом</span> Folem KM Чорний від USB (Power Bank).</h1>
