        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {advantage.map((el) => (
                    ...
                    >
                        <div className={`flex items-center justify-center w-16 h-16 mb-4 ${el.bgColor} text-white rounded-full`}>
                            <img src={el.icon} alt={el.title} />
                        </div>
                        <h3 className="text-xl font-semibold text-gray-800 mb-2">{el.title}</h3>
